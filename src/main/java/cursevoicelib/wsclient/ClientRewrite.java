 ...
 */
public abstract class ClientRewrite extends WebSocketAdapter implements Runnable, WebSocket {
	...
	public ClientRewrite( URI serverURI ) {
	 ...
	 */
	public ClientRewrite( URI serverUri , Draft draft ) {
		this( serverUri, draft, null, 0 );
	}

	public ClientRewrite( URI serverUri , Draft protocolDraft , Map<String,String> httpHeaders , int connectTimeout ) {
		if( serverUri == null ) {
